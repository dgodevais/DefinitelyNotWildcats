...
def convert_business_json_file_to_csv(json_file_path, csv_file_path):
    """
    Writes the business.json file into a csv
    :param json_file_path: (str) path to the business.json file
